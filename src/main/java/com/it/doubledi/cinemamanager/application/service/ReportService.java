...
public interface ReportService {
    ...
    List<RevenueReportResponse> revenueReportByMonth(RevenueReportRequest request);

    List<OccupancyRateReportResponse> occupancyRateReport(OccupancyRateReportRequest request);

    List<OccupancyRateReportResponse> occupancyRateReportByMonth(OccupancyRateReportRequest request);
}
